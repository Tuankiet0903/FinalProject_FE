  ...
  return (
    ...
    >
      ...
      <table className="w-full text-left">
        <thead>
          <tr>
            <th className="text-sm font-medium text-gray-500">Name</th>
            <th className="text-sm font-medium text-gray-500">Priority</th>
            <th className="text-sm font-medium text-gray-500">Due Date</th>
          </tr>
        </thead>
        <tbody>
