        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm">
            <div className="flex flex-row items-center justify-between pb-2">
              <h3 className="text-sm font-medium text-gray-700">Total Workspaces</h3>
          ...
          <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm">
            <div className="flex flex-row items-center justify-between pb-2">
              <h3 className="text-sm font-medium text-gray-700">Active Workspaces</h3>
              <Users className="h-4 w-4 text-gray-500" />
            </div>
            <div className="text-2xl font-bold">{data[data.length - 1].active}</div>
            <div className="text-xs text-gray-500">
              {Math.round((data[data.length - 1].active / currentTotal) * 100)}% of total
            </div>
          </div>
          ...
          <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm">
            <div className="flex flex-row items-center justify-between pb-2">
              <h3 className="text-sm font-medium text-gray-700">Average Users per Workspace</h3>
              <Users className="h-4 w-4 text-gray-500" />
            </div>
            <div className="text-2xl font-bold">8.3</div>
            <div className="text-xs text-gray-500">+12% from previous {period}</div>
          </div>

          {/* Growth Rate Card */}
          <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm">
            <div className="flex flex-row items-center justify-between pb-2">
              <h3 className="text-sm font-medium text-gray-700">Workspace Growth Rate</h3>
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          <div className="col-span-2 rounded-lg border border-gray-200 bg-white shadow-sm">
            <div className="p-4 border-b border-gray-200">
              ...
              <p className="text-sm text-gray-500">Distribution of workspaces by size and activity</p>
            </div>
            <div className="p-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <div className="text-sm font-medium">Medium (6-20 users)</div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <div className="text-sm font-medium">Large (21-50 users)</div>
                    <div className="text-sm text-gray-500">18%</div>
                  </div>
                  <div className="h-2 w-full rounded-full bg-gray-200">
                    <div className="h-2 rounded-full bg-blue-500" style={{ width: "18%" }} />
                  </div>
                </div>
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <div className="text-sm font-medium">Enterprise (50+ users)</div>
                    <div className="text-sm text-gray-500">5%</div>
                  </div>
                  <div className="h-2 w-full rounded-full bg-gray-200">
                    <div className="h-2 rounded-full bg-blue-500" style={{ width: "5%" }} />
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="rounded-lg border border-gray-200 bg-white shadow-sm">
            <div className="p-4 border-b border-gray-200">
              ...
              <p className="text-sm text-gray-500">Manage workspace analytics</p>
            </div>
