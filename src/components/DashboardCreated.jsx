...
// Mock Data for Space with createdBy
const spaces = [
  ...
  { spaceId: 3, name: "Backend Architecture", description: "Backend services and architecture design.", favorite: true, createdBy: 1, workspaceId: 1 },
  { spaceId: 4, name: "QA Testing", description: "Quality assurance testing tasks and resources.", favorite: false, createdBy: 3, workspaceId: 1 },
  { spaceId: 5, name: "Design UI/UX", description: "UI/UX design and mockups.", favorite: true, createdBy: 2, workspaceId: 1 },
  { spaceId: 6, name: "Design System", description: "Design system guidelines and components.", favorite: true, createdBy: 1, workspaceId: 1 },
];
